    ...
    return function(i) {
            ...
            return n(e, [{
                ...
                value: function(t, e) {
                    ...
                    return this.events.set(t, [].concat(function(t) {
                        ...
                        return Array.from(t)
                    }(this.events.has(t) ? this.events.get(t) : []), [e])), function() {
        ...
        var o = function(t) {
            ...
            return function(t, e) {
                ...
                value: function() {
                    var e = this;
                    this.options.vertical ? (this._ui.wrapper.style.height = Object(s.c)(this._slides[0]) * this.slidesToShow, this.options.centerMode && (this._ui.wrapper.style.padding = this.options.centerPadding + " 0px")) : this.options.centerMode && (this._ui.wrapper.style.padding = "0px " + this.options.centerPadding),
        ...
        var o = function(t) {
            ...
            return function(t, e) {
                ...
                value: function() {
                    ...
                    this.slider.options.pauseOnHover && (this.slider.container.addEventListener(s.a, this.onMouseEnter), this.slider.container.addEventListener(s.b, this.onMouseLeave))
                }
            }, {
                key: "_unbindEvents",
                value: function() {
                ...
                value: function() {
                    var t = this;
                    this.stop(),
                    this.slider.options.autoplay && (this.emit("start", this), this._interval = setInterval(function() {
        ...
        var a = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    var e = this,
                        t = void 0;
                    (t = this.slider.options.infinite ? Math.ceil(this.slider.state.length - 1 / this.slider.slidesToScroll) : Math.ceil((this.slider.state.length - this.slider.slidesToShow) / this.slider.slidesToScroll)) !== this._count && (this._count = t, this._draw()),
            ...
            return r(e, [{
                ...
                value: function(t) {
                    if (this._origin) {
                        ...
                        t.touches && Math.abs(this._lastTranslate.x) > Math.abs(this._lastTranslate.y) && (this._supportsPassive || t.preventDefault(), t.stopPropagation())
                    }
                }
            }, {
                key: "onStopDrag",
            ...
            return r(e, [{
                ...
                value: function(t, e) {
                    if (!this._animating || t) {
                        ...
                        t ? this._animation && this._animation.disable() : (this._animation && this._animation.enable(), this._animating = !0),
        ...
        var n = function() {
            ...
            return o(n, [{
                ...
                value: function() {
                    ...
                    this._newSlide && (this._newSlide.removeEventListener("transitionend", this.onTransitionEnd.bind(this)), this._newSlide.style.transition = "none", this._oldSlide && (this._oldSlide.removeEventListener("transitionend", this.onTransitionEnd.bind(this)), this._oldSlide.style.transition = "none"))
                }
            }, {
                key: "apply",
                value: function(t) {
            ...
            return a(n, [{
                ...
                value: function() {
                    ...
                    if ("translate" === this.options.effect) {
                        ...
                        this.options.loop && (!this.options.vertical && Math.abs(this._position.x) > t.x ? (s.x = 0, this.slider.state.next = 0) : this.options.vertical && Math.abs(this._position.y) > t.y && (s.y = 0, this.slider.state.next = 0)),
                        ...
                        "rtl" === this.slider.direction && (this._position.x = -this._position.x, this._position.y = -this._position.y),
